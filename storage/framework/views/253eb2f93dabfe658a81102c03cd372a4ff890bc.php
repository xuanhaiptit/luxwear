                ...
                <form role="form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="txtname_cate_en">Tên loại sản phẩm (en)</label>
                                <input type="text" class="form-control" value="<?php echo $cate_detail['name_detail_en']; ?>" name="txtname_cate_en" id="txtname_cate_en">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Online\web\ismart\resources\views/admin/cate_product_detail/edit.blade.php ENDPATH**/ ?>