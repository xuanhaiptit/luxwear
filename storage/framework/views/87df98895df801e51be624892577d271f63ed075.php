        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">
                        <a href="<?php echo e(route('get.add.cate_product_detail')); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Thêm mới</a>
                    </h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover" id="product_detail_table">
                        ...
                        <tr>
                            ...
                            <th><span class="thead-text">Tên loại sản phẩm (en)</span></th>
    ...
    <script>
        $(document).ready(function(){
            ...
            var dataTable = $('#product_detail_table').DataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('get.data.cate_product_detail')); ?>",
                    type:'post',
                },
                ...
                columns: [
                    ...
                    { data: 'name_detail_en', name: 'name_detail_en',targets: 3 },
            ...
            $(document).on('change', '[data-toggle="toggle"]', function(){
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: '<?php echo e(route('get.changeStatusCateProductDetail')); ?>',
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp_7\htdocs\ismart\resources\views/admin/cate_product_detail/list.blade.php ENDPATH**/ ?>