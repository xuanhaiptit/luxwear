                    ...
                    <form class="change_password_bs" method="post">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="password" class="form-control" id="password_old" name="password_old" placeholder="@lang('home.password_old')">
                            </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="password" class="form-control" id="password_new" name="password_new" placeholder="@lang('home.password_new')">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <i class="fa fa-check"></i>
                                ...
                                <input type="password" class="form-control" name="password_confirm" placeholder="@lang('home.confirm_password')">
                            </div>
                            <span class="error password_confirm_error" style="display: none"></span>
                        </div>
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary btn-lg">@lang('home.change_pw')</button>
                        </div>
                        <div class="form-group" >
