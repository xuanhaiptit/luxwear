            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" readonly="readonly" value="<?php echo $item['fullname']; ?>">
                    </div>
                        <div class="form-group">
                ...
                <div id="main-content-wp" class="clearfix blog-page"style="background: #f7f7f7;padding-top: 25px;padding-bottom: 75px;">
                    <div id="wrapper" class="wp-inner clearfix">
                        ...
                        <div class="form-group" style="float: right">
                            <?php if($check_print_bill->status != 4): ?>
                                <div class="fl-right">
                                    <a href="<?php echo route('get.inhoadon',$item['bill_id']); ?>"><i class="fa fa-print" aria-hidden="true" style="color:black;margin-right:5px"> Print</i></a>
                                </div>
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Online\web\ismart\resources\views/admin/bill/bill_detail.blade.php ENDPATH**/ ?>