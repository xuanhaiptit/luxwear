                    ...
                    <div class="col-md-12">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="sltcate" id="sltcate">
                                    @foreach($cate as $item)
                                        @if($cate_detail['parent_id'] == $item['id'])
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{!! $cate_detail['name'] !!}" name="txtname_cate" id="txtname_cate">
                                <span class="error">{!! $errors->first('txtname_cate') !!}</span>
                            </div>
                            <div class="form-group">
                                <label for="txtname_cate_en">Tên loại sản phẩm (en)</label>
                                <input type="text" class="form-control" value="{!! $cate_detail['name_detail_en'] !!}" name="txtname_cate_en" id="txtname_cate_en">
