    ...
    <script>
        $(document).ready(function(){
            $(document).on('click','#edit_ajax',function(e){
                ...
                var url = "/ismart/admin/product/product_edit/"+id;
                $.ajax({
                    url:url,
                    type:'post',
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ismart\resources\views/admin/product/edit.blade.php ENDPATH**/ ?>