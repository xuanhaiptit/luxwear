...
class ProductController extends Controller
{
    ...
    public function __construct(ProductRepository $productRepo, CateProductDetailRepository $cate_product_detailRepo, ImageRepository $imageRepo, ProductSizeRepository $productSizeRepo, SizeRepository $sizeRepo)
    {
    ...
    public function get_list()
    {
        ...
        $product_sizes = $this->product_sizeRepo->sizeProduct();
        $products = $this->productRepo->all();
        return view('admin.product.list', compact('products', 'product_sizes'));
    }
    ...
    public function get_add(Request $request)
    {
        ...
        return view('admin.product.add', compact('cate_detail', 'sizes'));
    }
    ...
    {
        $sizes = $this->sizeRepo->all();
        $product_sizes = $this->product_sizeRepo->sizeProduct($id);
        $cate_detail = $this->cate_product_detailRepo->all();
        $product = $this->productRepo->findOrFail($id);
        $list_image = $this->productRepo->findOrFailPosition($id);
        return view('admin.product.edit', compact('cate_detail', 'product', 'list_image', 'sizes', 'product_sizes'));
    }
    ...
    public function post_edit(Request $request, $id)
    {
        ...
        {
            $product_sizes = $this->product_sizeRepo->sizeProduct($id);
            $this->productRepo->updateProduct($request, $id, $product_sizes);
            return response()->json([
                'error' => false,
