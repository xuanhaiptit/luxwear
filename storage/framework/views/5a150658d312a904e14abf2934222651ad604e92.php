                                ...
                                <div class="box-body">
                                    <div class="col-md-9">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo old('product_name'); ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                   value="<?php echo old('product_name_en'); ?>" name="product_name_en"
                                                   id="product_name_en">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <label class="container">Size <?php echo e($size->name); ?>
                                                    ...
                                                    <input type="checkbox" name="size_product[]" value="<?php echo e($size->id); ?>">
                                                    <span class="checkmark"></span>
                                                    <input type="text" class="" value="<?php echo old('amount_size'); ?>"
                                                           name="amount_size[]" id="amount_size[]" placeholder="Số lượng size <?php echo e($size->id); ?>">
                                                </label>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo old('price_new'); ?>"
                                                   name="price_new" id="price_new">
                                            <span class="error price_new_error" style="display: none"></span>
                                        </div>
                                        <div class="form-group">
                                            <label for="price_old">Giá cũ</label>
                                            <input type="text" class="form-control" value="<?php echo old('price_old'); ?>"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo old('qty_product'); ?>"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Online\web\ismart\resources\views/admin/product/add.blade.php ENDPATH**/ ?>