...
<head>
    ...
    <link href="{{ url('public/admin/js/bootstrap/bootstrap-toggle.min.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ url('public/admin/css/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet" type="text/css"/>

    <!-- Page level plugin CSS-->
    <link href="{{ url('public/admin/datatables/dataTables.bootstrap4.css') }}" rel="stylesheet">
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('public/admin/css/import/style.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ url('public/admin/css/import/responsive.css') }}">
    ...
    <!-- SweetAlert2 -->
    <link rel="stylesheet" href="{!! url('public/admin/js/sweetalert/sweetalert2.min.css') !!}">


    <script src="{!! url('public/admin/js/sweetalert/sweetalert2.all.min.js') !!}"></script>
    ...
    <script src="{{ url('public/admin/js/bootstrap/bootstrap-toggle.min.js') }}" type="text/javascript"></script>
    <script src="{{ url('public/admin/js/plugins/ckeditor/ckeditor.js') }}" type="text/javascript"></script>
    ...
    <script src="{{ url('public/admin/js/check.js') }}" type="text/javascript"></script>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ asset('resources/upload/admin/'.Auth::guard('admin')->user()->avatar) }}" class="user-image" alt="User Image">
                        ...
                        <li class="user-body">
                            <div class="row">
                                <div class="col-xs-4 text-center btn btn-success">
                                    <a href="{{ url('admin/admin/update/'.Auth::guard('admin')->user()->id) }}">Profile</a>
                                </div>
                                <div class="col-xs-4 text-center btn btn-success">
                                    <a href="{{ url('admin/admin/change_pass/'.Auth::guard('admin')->user()->id) }}">Change Pw</a>
                                </div>
                                <div class="col-xs-4 text-center btn btn-success">
