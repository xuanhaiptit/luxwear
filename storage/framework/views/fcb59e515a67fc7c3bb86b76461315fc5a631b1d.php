    ...
    <script>
        $(document).ready(function(){
            ...
            var dataTable = $('#comment_table').DataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('get.data.comment')); ?>",
                    type:'post',
                },
            ...
            $(document).on('change', '[data-toggle="toggle"]', function(){
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: '<?php echo e(route('get.changeStatusComment')); ?>',
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Online\web\ismart\resources\views/admin/comment/list.blade.php ENDPATH**/ ?>