        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">
                        <a href="{{ route('get.add.cate_product') }}" class="btn btn-success"><i class="fa fa-plus"></i> Thêm mới</a>
                    </h3>
                </div>
                <!-- /.box-header -->
    ...
    <script>
        $(document).ready(function(){
            ...
            var dataTable = $('#cate_product_table').DataTable({
                ...
                ajax: {
                    url: "{{ route('get.data.cate_product') }}",
                    type:'post',
                },
            ...
            $(document).on('change', '[data-toggle="toggle"]', function(){
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: '{{route('get.changeStatusCateProduct')}}',
