                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <label class="radio-inline"><input type="radio" name="radio_status"
                                                                                   value="1" <?php echo ($product['status'] == 1) ? 'checked' :null; ?> >Hiển
                                                    thị</label>
                                                <label class="radio-inline"><input type="radio" name="radio_status"
                                                                                   value="0" <?php echo ($product['status'] == 0) ? 'checked' :null; ?>>Không
                                                    hiển thị</label>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                       value="<?php echo $product['product_name_en']; ?>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <?php $__currentLoopData = $product_sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <?php endif; ?>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <label class="container">Size <?php echo e($size->name); ?>

                                                        <input type="checkbox" name="size_product[]"
                                                               value="<?php echo e($size->id); ?>" <?php echo e($checked); ?>>
                                                        <span class="checkmark"></span>
                                                        <input type="text" class="" value="<?php echo $amount; ?>"
                                                               name="amount_size[]" id="amount_size[]"
                                                               placeholder="Số lượng size <?php echo e($size->id); ?>">
                                                    </label>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <img style="width: 100px;height: 100px;"
                                                     src="<?php echo e(asset('resources/upload/product/'.$product->image)); ?>"
                                                     alt="">
                                            </div>
                                            <div class="form-group">
                                                <label for="price_new">Giá mới</label>
                                                <input type="text" class="form-control"
                                                       value="<?php echo old('price_new'),isset($product) ? $product['price_new'] :null; ?>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                       value="<?php echo old('price_old'),isset($product) ? $product['price_old'] :null; ?>"
                                                       name="price_old" id="price_old">
                                            </div>
                                            <div class="form-group">
                                                <label for="qty_product">Số lượng tồn kho</label>
                                                <input type="text" class="form-control"
                                                       value="<?php echo old('qty_product'),isset($product) ? $product['qty_product'] :null; ?>"
                                                        ...
                                                        <?php $__currentLoopData = $list_image; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li id="<?php echo e($item['id']); ?>">
                                                                <div class="form-group" id="<?php echo $key; ?>">
                                                                    <img style="width: 100px; height: 100px;"
                                                                         src="<?php echo asset('resources/upload/product_detail/'.$item['image']); ?>"
                                                                         idHinh="<?php echo $item['id']; ?>" id="<?php echo $key; ?>">
                        ...
                        <div id="tabs-2" class="tab-pane fade">
                            <div class="form-group">
                                ...
                                <textarea name="desc" id="desc"
                                          class="ckeditor"><?php echo old('desc'),isset($product) ? $product['desc'] :null; ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="content">Nội dung (vn)</label>
                                <textarea name="content" id="content"
                                          class="ckeditor"><?php echo old('content'),isset($product) ? $product['content'] :null; ?></textarea>
                            </div>
                        </div>
                        <div id="tabs-3" class="tab-pane fade">
                            <div class="form-group">
                                ...
                                <textarea name="desc_en" id="desc_en"
                                          class="ckeditor"><?php echo old('desc_en'),isset($product) ? $product['desc_en'] :null; ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="content">Nội dung (en)</label>
                                <textarea name="content_en" id="content_en"
                                          class="ckeditor"><?php echo old('content_en'),isset($product) ? $product['content_en'] :null; ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Online\web\ismart\resources\views/admin/product/edit.blade.php ENDPATH**/ ?>