                ...
                <div class="section" id="detail-product-wp">
                    <div class="section-detail clearfix">
                        <div class="thumb-wp fl-left">
                            <a href="" id="main-thumb" class="clearfix">
                                <div style="height:356px;width:356px;" class="zoomWrapper"><img id="zoom"
                                                                                                src="<?php echo e(asset('resources/upload/product/'.$ctsp['image'])); ?>"
                                                                                                data-zoom-image="<?php echo e(asset('resources/upload/product/'.$ctsp['image'])); ?>"
                            ...
                            <div id="list-thumb">
                                <?php if(isset($list_image)): ?>
                                    <?php $__currentLoopData = $list_image; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href=""
                                           data-image="<?php echo e(asset('resources/upload/product_detail/'.$item['image'])); ?>"
                                           data-zoom-image="<?php echo e(asset('resources/upload/product_detail/'.$item['image'])); ?>">
                                            <img id="zoom-img"
                                                 src="<?php echo e(asset('resources/upload/product_detail/'.$item['image'])); ?>"/>
                                        </a>
                        ...
                        <div class="info fl-right">
                            ...
                            <form action="<?php echo e(route('add.cart',$ctsp->id)); ?>" id="form-add-cart" method="GET"
                                ...
                                <ul>
                                    <?php $__currentLoopData = $product_sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <input type="radio" id="<?php echo e($product_size->id); ?>" name="product_size_id"
                                               value="<?php echo e($product_size->id); ?>">
                                        <label for="<?php echo e($product_size->id); ?>">Size <?php echo e($product_size->name); ?></label><br>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                    ...
                    <div class="component_rating" style="margin-bottom: 20px">
                                        ...
                                        <div style="width:70%;margin: 0 20px;">
                                            <span
                                                style="width: 100%;height: 8px;display: block;border:1px solid #dedede;border-radius: 5px;background-color:#dedede "><b
                                                    style="width: <?php echo $itemAge; ?>%;background-color: #f25800;display: block;height: 100%;border-radius: 5px;"></b></span>
                                        </div>
                                        <div style="width:20%">
                        ...
                        <div class="form_rating hide">
                            ...
                            <div style="margin-top: 15px;">
                                <?php if(Auth::check()): ?>
                                    <a href="<?php echo route('post.save.products',$ctsp->id); ?>" class="js_rating_product"
                            ...
                            <?php if(isset($danhgia)): ?>
                                <?php $__currentLoopData = $danhgia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="rating_item" style="margin: 10px 0">
                                        <div>
                                            <span
                                                style="color: #333;font-weight: bold;text-transform: capitalize;"><?php echo e(isset($item->user->fullname)? $item->user->fullname : ''); ?></span>
                            ...
                            <ul class="list-item">
                                <?php $__currentLoopData = $product_cate_same; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        ...
                                        <a href="<?php echo url('ctsp',[$item['id'],$item['alias']]); ?>" title=""
                                           class="thumb">
                                        ...
                                        <div class="price">
                                            <span
                                                class="new"><?php echo number_format($item['price_new'],0,",","."); ?> đ</span>
                                            <?php if($item['price_old'] != 0): ?>
                                                <span
                                                    class="old"><?php echo number_format($item['price_old'],0,",","."); ?> đ</span>
                                            <?php else: ?>
                                            <?php endif; ?>
                                        </div>
                                        <div class="action clearfix">
                                            <div class="product-icon-container">
                                                <a href="<?php echo route('add.cart',$item['id']); ?>" title="Thêm giỏ hàng"
                                                   class="add-cart"><?php echo app('translator')->getFromJson('home.add_to_cart'); ?></a>
                                            </div>
                                        </div>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Online\web\ismart\resources\views/pages/product/detail_product.blade.php ENDPATH**/ ?>