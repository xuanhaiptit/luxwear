        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">
                        <a href="<?php echo e(route('get.add.product')); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Thêm mới</a>
    ...
    <script>
        $(document).ready(function(){
            ...
            var dataTable = $('#product_table').DataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('get.data.products')); ?>",
                    type:'post',
                },
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp_7\htdocs\ismart\resources\views/admin/product/list.blade.php ENDPATH**/ ?>