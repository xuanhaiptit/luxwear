                            ...
                            <div class="col-md-12">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{!! old('page_title_en'),isset($page) ? $page['page_title_en'] :null !!}" name="page_title_en" id="page_title_en">
                                        <span class="error">{!! $errors->first('page_title_en') !!}</span>
                                    </div>

                                    <div class="form-group">
                                        <label for="desc_en">Mô tả ngắn (en)</label>
                                        <textarea name="desc_en" id="desc_en" class="ckeditor">{!! old('desc_en'),isset($page) ? $page['desc_en'] :null !!}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="content_en">Nội dung (en)</label>
                                        <textarea name="content_en" id="content_en" class="ckeditor">{!! old('content_en'),isset($page) ? $page['content_en'] :null !!}</textarea>
                                    </div>
                                </div>
